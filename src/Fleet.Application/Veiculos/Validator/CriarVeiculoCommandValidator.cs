    ...
    public sealed class CriarVeiculoCommandValidator : AbstractValidator<CriarVeiculoCommand>
    {
        public CriarVeiculoCommandValidator()
        {
            RuleFor(x => x.Placa)
                ...
                .Length(7).WithMessage("A placa deve conter 7 caracteres.");
            RuleFor(x => x.Renavam)
                .NotEmpty().WithMessage("O Renavam é obrigatório.")
                .Length(11).WithMessage("O Renavam deve conter 11 caracteres.");
            RuleFor(x => x.Chassi)
                .NotEmpty().WithMessage("O chassi é obrigatório.")
                .Length(17).WithMessage("O chassi deve conter 17 caracteres.");
